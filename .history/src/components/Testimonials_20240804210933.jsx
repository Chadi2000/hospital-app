...
const Testimonials = () => {
  return (
    <div className='flex flex-col pt-[100px] px-[80px] gap-8'>
      ...
      <div className='bg-black w-full h-[348px] py-8 px-12'>
        <h3 className='text-white text-[40px] leading-[50px] font-semibold tracking-[5%] mb-[150px]'>Let's consult your health with our doctor</h3>
      </div>
      <div></div>
    </div>
  )
