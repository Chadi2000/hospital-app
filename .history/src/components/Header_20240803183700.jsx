...
const Header = () => {
  return (
    <div className='flex px-[80px] mt-[50px] gap-[100px]'>
      ...
      <div className='relative flex justify-center items-center bg-btn h-[577.1px] w-[577.1px] rounded-full overflow-hidden'>
        <img src={Doctor} alt="doctor" className='absolute h-[691.55px] w-full rounded-full object-cover' />
      </div>
