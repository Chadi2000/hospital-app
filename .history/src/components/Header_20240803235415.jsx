  ...
  return (
    <div className='flex px-[80px] mt-[50px] gap-[100px]'>
      ...
      <div className='flex flex-col justify-start gap-10 pt-[200px] w-1/2'>
        ...
        <p style={{color:'#999999'}} className='text-[20px] font-medium leading-[31.2px]'>check now your healty with our profesional doctor, completed and modern fasilities services</p>
