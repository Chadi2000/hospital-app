...
const Header = () => {
  return (
    <div className='flex px-[80px] mt-[50px] gap-[100px]'>
      ...
      <div className='flex justify-center items-center bg-btn h-[577.1px] w-[577.1px] rounded-full overflow-bottom-hidden'>
        <img src={Doctor} alt="doctor" className='h-[691.55px] w-[389.54px] rounded-full object-cover' />
      </div>
