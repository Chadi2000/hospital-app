  ...
  return (
    <div className='flex px-[80px] border-[10px] mt-[50px]'>
      ...
      <div className='flex justify-center items-center text-center'>
        <div className='relative bg-btn h-[577.1px] w-[577.1px] rounded-full'>
            <div className='absolute bottom-0 rounded-full flex items-center justify-center'>
                <img src={Doctor} alt="doctor" className=' h-[691.55px] rounded-full' />
            </div>
        </div>
