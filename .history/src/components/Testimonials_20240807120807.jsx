  ...
  return (
    <div className='flex flex-col pt-[60px] text-center md:text-start md:pt-[100px] px-6 md:px-[80px] gap-8'>
      ...
      <div className='flex flex-col justify-between bg-black w-full h-[248px] md:h-[348px] py-5 md:py-8 px-7 md:px-12'>
        <h3 className='text-white text-[25px] md:text-[32px] lg:text-[40px] leading-[50px] font-semibold tracking-[5%] capitalize'>Let's consult your health with our doctor</h3>
        <div className='flex gap-2 items-center flex-col md:flex-row justify-between'>
            <p className='text-white text-[18px] leading-[28px] font-semibold tracking-[5%] capitalize'>we will provide the best service.</p>
