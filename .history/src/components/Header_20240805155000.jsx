...
const Header = () => {
  return (
    <div className='flex flex-col md:flex-row px-[40px] md:px-[80px] mt-[50px] gap-[100px]'>
      ...
      <div className='relative items-center flex justify-center bg-btn w-[377.1px] h-[377.1px] lg:h-[577.1px] lg:w-[577.1px] rounded-full'>

        <img src={Doctor} alt="doctor" className='absolute h-[450px] lg:h-[691.55px] w-full rounded-full bottom-0' />
