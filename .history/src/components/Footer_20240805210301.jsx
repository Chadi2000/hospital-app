  ...
  return (
    <div className='flex flex-col md:flex-row justify-between  gap-10 bg-services py-[90px] md:py-[150px] px-[50px] md:px-[80px]'>
        ...
        <div className="flex flex-col items-center justify-between gap-6">
            ...
            <input type="email" className="w-full h-50px md:h-74px pl-4 bg-input text-white font-semibold text-[16px] md:text-[20px] leading-[30px] md:leading-[50px] tracking-[5%]" placeholder="Enter Your Email" />
