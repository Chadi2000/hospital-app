...
const Navbar = () => {
  ...
  return (
    <div className="flex relative justify-between pt-[35px] sm:px-[40px] lg:px-[80px] ">
      ...
      {isMobileMenuOpen && (
        <div className="absolute right-[30px] flex flex-col pr-[40px]   top-20 bg-white md:hidden">
