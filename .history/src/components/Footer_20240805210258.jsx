...
const Footer = () => {
  return (
    <div className='flex flex-col md:flex-row justify-between  gap-10 bg-services py-[90px] md:py-[150px] px-[50px] md:px-[80px]'>

        <div className='flex flex-col justify-between items-center md:w-[30%] gap-6'>
            <div className='flex'>
        ...
        <div className="flex flex-col items-center justify-between gap-6">
            ...
            <input type="email" className="w-full h-50px md:h-74px pl-4 bg-input text-white font-semibold text-[16px] md:text-[20px] leading-[35px] md:leading-[50px] tracking-[5%]" placeholder="Enter Your Email" />
            <button className=" bg-btn w-[180px] md:w-[216px] h-[63px] rounded-[5px] font-medium text-[18px] leading-[27px] tracking-[5%] cursor-pointer text-white">Subscribe</button>
        </div>
