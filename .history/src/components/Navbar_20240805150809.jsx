...
const Navbar = () => {
  ...
  return (
    <div className="flex justify-between py-[35px] sm:px-[40px] lg:px-[80px] ">
      ...
      {isMobileMenuOpen && (
        <div className="flex flex-col items-center absolute top-20 left-0 w-full bg-white md:hidden">
          <ul className="flex flex-col gap-4 py-4 font-medium text-[18px] leading-[27px]">
            <li className="cursor-pointer" onClick={toggleMobileMenu}>About</li>
            <li className="cursor-pointer" onClick={toggleMobileMenu}>Home</li>
            <li className="cursor-pointer" onClick={toggleMobileMenu}>Service</li>
            <li className="cursor-pointer" onClick={toggleMobileMenu}>Login</li>
          </ul>
        </div>
      )}
