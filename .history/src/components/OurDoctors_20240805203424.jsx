...
const OurDoctors = () => {
  return (
    <div className='flex flex-col items-center bg-services gap-[40px] py-[150px]'>
      ...
      <h3 className='capitalize text-[30px] md:text-[40px] leading-[50px] font-semibold tracking-[5%] text-center'>visit our professional specialists</h3>
      <div className="flex flex-col px-5 items-center md:flex-row md:flex-wrap gap-[70px] md:gap-5">
