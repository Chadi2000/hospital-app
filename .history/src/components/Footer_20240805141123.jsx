...
import { FaFacebook, FaInstagram, FaWhatsapp, FaLinkedin, FaYoutube, FaBars } from "react-icons/fa"

const Footer = () => {
  return (
    <div className='flex justify-between items-center bg-services py-[150px] px-[80px]'>
