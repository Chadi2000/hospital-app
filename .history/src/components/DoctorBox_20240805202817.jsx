...
const DoctorBox = ({img, name, major}) => {
  return (
    <div className="flex flex-col items-center relative w-[208px] lg:w-[308px] h-[277px] lg:h-[377px]">
      ...
      <div className='absolute  bg-white w-[180px] lg:w-[260px] h-[100px] lg:h-[139px] bottom-[-18%] rounded-[5px] border-[1px] px-5 py-3 flex flex-col justify-between'>
        <div className='flex gap-5'>
         ...
         <div className='font-bold tex-[15px] lg:text-[20px] leading-[20.5px] tracking-[5%] capitalize'>
            {name}
         </div>
