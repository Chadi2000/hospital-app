...
const AboutUs = () => {
  return (
    <div className='flex items-center flex-col lg:flex-row gap-[150px] px-[20px] lg:px-[100px]  py-[100px]'>
      ...
      <div className='flex flex-col items-start gap-10 pt-14 md:w-[50%]'>
        <h6 className='font-semibold text-[20px] text-center leading-[50px] text-title'>About Us</h6>
