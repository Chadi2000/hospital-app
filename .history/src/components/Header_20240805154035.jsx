...
const Header = () => {
  return (
    <div className='flex flex-col md:flex-row px-[40px] md:px-[80px] mt-[50px] gap-[120px]'>
      ...
      <div className='relative flex justify-center pt-10 bg-btn w-[377.1px] h-[377.1px] md:h-[577.1px] md:w-[577.1px] rounded-full'>

        <img src={Doctor} alt="doctor" className='absolute h-[450px] md:h-[691.55px] w-full rounded-full bottom-0' />
