...
const Header = () => {
  return (
    <div className='flex flex-col items-center md:flex-row px-[40px] md:px-[30px] mt-[50px] gap-[100px]'>
      ...
      <div className='relative  flex bg-btn w-[377.1px] h-[377.1px] lg:h-[577.1px] lg:w-[577.1px] rounded-full'>
