...
const Navbar = () => {
  ...
  return (
    <div className="flex relative justify-between  sm:px-[40px] lg:px-[80px] ">
      ...
      {isMobileMenuOpen && (
        <div className="absolute right-[40px] flex flex-col pr-[40px] border-[1px] items-end  top-20 bg-white md:hidden">
