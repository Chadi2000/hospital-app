...
const Footer = () => {
  return (
    <div className='flex items-center justify-between bg-services py-[150px] px-[80px]'>
        ...
        <div className='flex flex-col justify-between  gap-6'>
            ...
            <p className='font-normal text-[18px] leading-[34px] tracking-[5%] w-[30%]'>Our hospital tries to answer the challenges in the community's need for quality dental health services but still affordable by a wide audience.</p>
