...
const DoctorBox = ({img, name, major}) => {
  return (
    <div className="flex flex-col items-center relative w-[208px] lg:w-[308px] h-[777px] lg:h-[377px]">
      <div>
        <img src={img} alt="man1" className='w-[208px] lg:w-[308px] h-[777px] lg:h-[377px] object-cover' />
      </div>
      <div className='absolute  bg-white w-[260px] h-[139px] bottom-[-18%] rounded-[5px] border-[1px] px-5 py-3 flex flex-col justify-between'>
