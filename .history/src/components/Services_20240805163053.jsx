...
const Services = () => {
  return (
    <div className='bg-services mt-8 lg:mt-14 flex flex-col gap-10 py-[50px] md:py-[70px] lg:py-[100px] w-full'>
      ...
      <div className='flex items-center md:items-start gap-14 justify-start  md:flex-wrap flex-col md:justify-center md:flex-row px-[40px] lg:px-[100px] md:gap-[70px] mt-[100px]'>
