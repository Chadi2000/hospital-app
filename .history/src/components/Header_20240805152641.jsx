...
const Header = () => {
  return (
    <div className='flex flex-col md:flex-row px-[80px] mt-[50px] gap-[100px]'>
      ...
      <div className='flex flex-col justify-start gap-10 md:pt-[200px] w-1/2'>
        <h1 className='text-[40px] md:text-[56px] font-bold leading-[61px] text-title'>we care about your health</h1>
        <p className='text-[20px] font-medium leading-[31.2px] text-txt'>check now your healty with our profesional doctor, completed and modern fasilities services</p>
