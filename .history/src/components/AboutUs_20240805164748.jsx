...
const AboutUs = () => {
  return (
    <div className='flex items-center flex-col justify-center text-center lg:flex-row lg:gap-[150px] px-[20px] lg:px-[100px]  py-[100px]'>
      ...
      <div className='flex flex-col items-start gap-10 pt-14 lg:w-[50%]'>
