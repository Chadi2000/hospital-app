...
const Testimonials = () => {
  return (
    <div className='flex flex-col pt-[60px] text-center md:pt-[100px] px-6 md:px-[80px] gap-8'>
      <h6 className='font-semibold text-[20px] heading-[50px] tracking-[5%]'>Testimonials</h6>
      <h3 className='font-semibold text-[30px] md:text-[40px] heading-[50px] tracking-[5%] xl:w-[60%]'>what they say after visiting our hospital</h3>
      <div className='flex flex-col items-center md:flex-row gap-5 justify-center flex-wrap'>
        {test.map((test,index) =>(
      ...
      <div className='flex flex-col justify-between bg-black w-full h-[248px] md:h-[348px] py-5 md:py-8 px-7 md:px-12'>
        <h3 className='text-white text-[25px] md:text-[40px] leading-[50px] font-semibold tracking-[5%] '>Let's consult your health with our doctor</h3>
