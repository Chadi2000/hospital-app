  ...
  return (
    <div className='flex flex-col lg:flex-row justify-between  gap-10 bg-services py-[90px] md:py-[150px] px-[50px] md:px-[80px]'>
        ...
        <div className='flex flex-col justify-between items-center md:items-start lg:w-[30%] gap-6'>
            ...
            <p className='font-normal text-[18px] leading-[34px] tracking-[5%] capitalize'>Our hospital tries to answer the challenges in the community's need for quality dental health services but still affordable by a wide audience.</p>
